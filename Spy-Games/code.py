...
def read_file(path):
 ...
 file = open(file_path, mode='r', buffering=-1, encoding=None, errors=None,   
...
def read_file(path):
 ...
 file = open(path, mode='r', buffering=-1, encoding=None, errors=None,   
 newline=None, closefd=True, opener=None)
 sentence = file.readline()
 file.close() 
 return sentence
...
def read_file(path):
 ...
 file = open(file_path_3, mode='r', buffering=-1, encoding=None, errors=None,   
 newline=None, closefd=True, opener=None)
 sentence = file.readline()
 file.close() 
 return sentence
